            ...
            while (true) {
                ...
                switch (op) {
                    case "1":
                        ...
                        System.out.println(server.createGame(nombre, rival) ? "Partida creada" : "No se pudo crear");
                        break;

                    case "2":
                        List<ShipDTO> barcos = new ArrayList<>();
                        barcos.add(new ShipDTO("VELERO", 0, 0, "HORIZONTAL"));
                        barcos.add(new ShipDTO("VELERO", 0, 2, "HORIZONTAL"));
                        barcos.add(new ShipDTO("VELERO", 0, 4, "HORIZONTAL"));
                        barcos.add(new ShipDTO("VELERO", 0, 6, "HORIZONTAL"));
                        barcos.add(new ShipDTO("FRAGATA", 2, 0, "HORIZONTAL"));
                        barcos.add(new ShipDTO("FRAGATA", 2, 3, "HORIZONTAL"));
                        barcos.add(new ShipDTO("FRAGATA", 2, 6, "HORIZONTAL"));
                        barcos.add(new ShipDTO("BUQUE", 4, 0, "HORIZONTAL"));
                        barcos.add(new ShipDTO("BUQUE", 4, 4, "HORIZONTAL"));
                        barcos.add(new ShipDTO("PORTAVIONES", 7, 0, "HORIZONTAL"));

                        System.out.println(server.putShips(nombre, barcos) ? "Barcos colocados" : "No válidos");
                        break;
